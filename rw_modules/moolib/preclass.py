...
def prep_conf(confpath):
    ...
    languages = {0: 'Arabic', 1: 'African', 2: 'Assamese', 3: 'Odia', 4: 'Bengali', 5: 'Bhojpuri', 6: 'Gujarati', 7: 'Haryanvi', 8: 'Hindi', 9: 'Kannada', 10: 'Malayalam', 11: 'Marathi', 12: 'Punjabi', 13: 'Tamil', 14: 'Telugu'}
    ...
    usr_location_inp = input('''Enter a single country code from above: ''')
    usr_location = {}
